...
const MicroTrendCoachTab = ({selectedClient}) => {
    ...
    useEffect(() => {
        const fetchMicroTrend = async () => {
            ...
            try {
              const response = await fetch("/api/client/micronutrients/trendbyclient", {
                method: "POST",
                body: JSON.stringify({startDate, endDate,selectedClient}),
              });
...
export default MicroTrendCoachTab;